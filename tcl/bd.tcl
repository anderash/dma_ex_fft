...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.C_ALL_OUTPUTS {1} CONFIG.C_GPIO_WIDTH {24}  ] $axi_gpio_0
  ...
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {false}  ] [get_bd_intf_nets axi_dma_0_m_axis_mm2s]
  ...
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {false}  ] [get_bd_intf_nets xfft_0_m_axis_data]

  # Create port connections
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins edge_detect_0/in] [get_bd_pins xfft_0/s_axis_config_tdata]
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {false}  ] [get_bd_nets axi_gpio_0_gpio_io_o]
  ...
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {false}  ] [get_bd_nets edge_detect_0_edge_detected]
  connect_bd_net -net processing_system7_0_fclk_clk0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins edge_detect_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins xfft_0/aclk]
  connect_bd_net -net processing_system7_0_fclk_reset0_n [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
