...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net event_data_in_channel_halt [get_bd_pins xfft_0/event_data_in_channel_halt]
  connect_bd_net -net event_data_out_channel_halt [get_bd_pins xfft_0/event_data_out_channel_halt]
  connect_bd_net -net event_frame_started [get_bd_pins xfft_0/event_frame_started]
  connect_bd_net -net event_status_channel_halt [get_bd_pins xfft_0/event_status_channel_halt]
  connect_bd_net -net event_tlast_missing [get_bd_pins xfft_0/event_tlast_missing]
  connect_bd_net -net event_tlast_unexpected [get_bd_pins xfft_0/event_tlast_unexpected]
